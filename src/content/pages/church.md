...
title: Church
permalink: /church/
description: Ascension of Christ is a confessional LCMS Lutheran church in Beverly Hills, MI, serving Oakland County. We gather around Word & Sacrament, holding to Scripture, the Lutheran Confessions, and the historic liturgy.
priority: 0.9
changefreq: monthly
---
...
<div class="flex flex-col items-center text-center p-[20px]">
    <div class="text-accent">
        <h2 class="uppercase text-[2.2rem]">About Our Church</h2>
    </div>
    <div class="text-white text-[1.25rem] mt-[15px]">
    ...
    <a href="https://bookofconcord.cph.org/" target="_blank" class="text-white hover:no-underline">
        <div class="max-w-[850px] p-[40px] bg-[rgba(197,160,89,0.05)] border-l-4 border-accent font-serif">
            <blockquote class="text-[1rem] m-0">
                "Our churches teach that people cannot be justified before God by their own strength, merits, or works. People are freely justified for Christ's sake, through faith, when they believe that they are received into favor and that their sins are forgiven for Christ's sake. By His death, Christ made satisfaction for our sins. God counts this faith for righteousness in His sight (Romans 3 and 4)."
            </blockquote>
            <cite class="block mt-[15px] text-accent font-bold not-italic">— Augsburg Confession, Article IV</cite>
        </div>
    </a>
    ...
    <div class="text-[1.25rem] w-full md:w-1/2 max-w-[1300px]">
        <div class="text-left pt-[25px]">
            <h3 class="text-light font-bold text-[1.35rem] text-accent mb-2">What We Believe, Teach, and Confess:</h3>
            <ul class="list-disc pl-5">
                <li class="text-white mb-2">God is triune: Father, Son, and Holy Spirit.</li>
                <li class="text-white mb-2">We are all by nature sinners in need of grace and forgiveness.</li>
