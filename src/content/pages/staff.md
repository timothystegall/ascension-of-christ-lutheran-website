...
<div class="bg-dark-bg text-link font-serif py-[40px] px-[20px] max-w-[900px] mx-auto">
  <header class="text-center mb-[30px]">
    <h1 class="text-accent uppercase tracking-[3px] text-[1.8rem] mb-[10px]">Our Staff</h1>
  ...
  <div class="flex flex-col gap-5 mb-[60px]">
    <div class="flex flex-col sm:flex-row border border-gold-dim rounded-sm overflow-hidden bg-[rgba(255,255,255,0.02)] items-stretch">
      <div class="w-full h-[300px] sm:w-[250px] sm:h-auto sm:flex-none border-b border-gold-dim sm:border-b-0 sm:border-r">
        <img src="/assets/images/pastor.jpg" alt="Rev. Larry K. Loree" class="w-full h-full object-cover block">
      </div>
      <div class="p-[25px] flex-1 flex flex-col justify-center text-left">
        <span class="text-accent font-bold text-[1.4rem] mb-[5px] block">Rev. Larry K. Loree</span>
        <span class="text-[0.9rem] uppercase tracking-[1px] opacity-80 mb-[15px] block">Pastor</span>
  ...
  <div class="border-l-[3px] border-accent py-[20px] px-[30px] bg-[rgba(255,255,255,0.03)] leading-[1.8]">
    <p>
