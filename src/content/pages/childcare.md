...
<div class="bg-dark-bg text-link font-serif max-w-[950px] mx-auto py-[40px] px-[20px]">
  ...
  <div class="border-l-[3px] border-accent bg-[rgba(255,255,255,0.02)] py-[25px] px-[20px] sm:px-[40px] mb-[40px] flex flex-col sm:flex-row gap-[20px] sm:gap-[40px] items-center">
    ...
    <div>
      ...
      <p class="mt-[0.25rem]">For enrollment inquiries, program information, or to schedule a tour, please reach out to our Program Director:</p>
      <ul class="list-none p-0 mt-[15px] space-y-[8px]">
        <li><strong class="text-accent">Director:</strong> Chelsea Cook</li>
        <li><strong class="text-accent">Email:</strong> <a href="mailto:cookc@ascensionofchrist.org">cookc@ascensionofchrist.org</a></li>
        <li><strong class="text-accent">Phone:</strong> <a href="tel:2486448890">248-644-8890</a></li>
      </ul>
    </div>
  </div>
  ...
  <h1 class="text-accent-blue uppercase tracking-[3px] text-center text-[2rem] mb-[20px]">Our Classrooms</h1>
  ...
  <div class="flex flex-col gap-[12px] mb-[40px]">
    ...
    <div class="flex flex-col sm:flex-row items-stretch gap-0 border border-border-dim bg-[rgba(255,255,255,0.02)] overflow-hidden">
      ...
      <div class="p-[25px]">
        ...
        <p class="text-[0.95rem] mt-0">Our infant team's primary focus is providing a safe, loving, nurturing environment that supports the growth and development of our babies. Consistent love, comfort, encouragement, and support are given daily. We encourage secure attachments with primary caregivers and nurture infants in a least-restrictive environment emphasizing learning through play, music, movement, and constant communication.</p>
      </div>
    </div>
