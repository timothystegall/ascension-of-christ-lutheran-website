# 🪐ascension-of-christ-lutheran-website Starter
...
<a href="https://github.com/Timothy Stegall/ascension-of-christ-lutheran-website/generate">
...
Prepare your repository for use by removing ascension-of-christ-lutheran-website branding and replacing it with your own project name and description.
...
<details>
<summary>2. Run the "Remove ascension-of-christ-lutheran-website branding" action</summary>

1. Click the "Actions" tab in the top navigation of your repository
2. Click the "Remove ascension-of-christ-lutheran-website branding" workflow
...
Start your project with ascension-of-christ-lutheran-website by clicking the "Use this template" button below:
...
Deploy your ascension-of-christ-lutheran-website site for **free** with GitHub Pages:
...
Deploy ascension-of-christ-lutheran-website to [Netlify](https://netlify.com) for **free**!
...
Deploy ascension-of-christ-lutheran-website to [Cloudflare Pages](https://pages.cloudflare.com/) for global edge performance:
...
ascension-of-christ-lutheran-website includes additional features that are disabled by default. Enable them when you need them:
...
* Reusable components via [eleventy-plugin-reusable-components](https://github.com/Timothy Stegall/eleventy-plugin-reusable-components)
...
```text
example.com                 # → Root of your ascension-of-christ-lutheran-website project
...
├── README.ascension-of-christ-lutheran-website.md     # → Template documentation
